    ...
    return await mutateAsync(
      ...
      },
      {
        onError: (error) => {
          ...
          // v4/social/hooks/useImageUpload. These were hardcoded English, so a
          // locale bundle never applied — and the generic body read "Please try
          // again." where web says "Upload Not Complete".
          if (
