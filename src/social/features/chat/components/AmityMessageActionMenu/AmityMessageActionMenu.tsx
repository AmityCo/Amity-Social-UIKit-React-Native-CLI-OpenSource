...
// `onLongPress → openPopover`. Web's ReactionPicker, flag-query loading skeleton
// and unreport row are intentionally dropped (not part of this batch's handler
// set). Item visibility follows web `buildBubbleMenuItems`.
...
const MUTED_VICTIM_TRIMMED_KEYS = new Set(['edit', 'reply', 'report']);
