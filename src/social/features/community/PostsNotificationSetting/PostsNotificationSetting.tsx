...
import { usePostsNotificationSetting } from './hooks/usePostsNotificationSetting';

export function PostsNotificationSetting({
  community,
  ...
  const {
    ...
    notifications,
    accessibilityId,
  } = usePostsNotificationSetting({ community });
